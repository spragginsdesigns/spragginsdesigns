...
<p align="center">
  <i>Architecting practical AI with Next.js + Python</i><br/>
  <i>Transforming unstructured sports content into actionable insight</i>
</p>
...
## 🧩 What I Do
- Design AI pipelines that convert messy content into structured, real-time insights  
- Ship robust web apps with fast UX, clean DX, and built-in accessibility  
- Operate production systems end-to-end (Vercel + Neon Postgres, Redis, Stripe, Auth0)  
- Keep code simple, typed, and maintainable
- Utilizing AI Coding Tools responsibly and usefully. 

---

## 🛠️ Stack
`Next.js 15` · `React` · `TypeScript` · `Tailwind` · `shadcn/ui`  
`Python` · `PostgreSQL (Neon)` · `Drizzle ORM` · `Redis`  
`Vercel` · `Ubuntu (Linode)` · `Docker` · `Stripe` · `Auth0`

<details>
<summary>More areas of interest</summary>

**AI/ML:** NLP, prompt design, scraping/processing, vector search  
**Frontend:** state/data (SWR, React Query, Zustand), UX writing, WCAG/ARIA  
**Backend:** REST APIs, background jobs, schema & perf tuning  
**Ops/Tools:** CI/CD, Linux, pnpm, pip, winget, testing culture
</details>
...
- Embedded AI in the dev loop to speed implementation, testing, and refactors
...
## 🎓 Education
**B.S., Computer Science** — Fresno State *(in progress, expected Jan 2026)*  
**A.S., Information Systems: Web Design** — Clovis Community (2021) • GPA 3.92  
**Certificate, Information Systems: Web Design** — Clovis Community (2020)

---

## 📬 Contact
- **Email:** <a href="mailto:austin@spragginsdesigns.xyz">austin@spragginsdesigns.xyz</a>  
- **LinkedIn:** <a href="https://linkedin.com/in/spragginsdesigns">linkedin.com/in/spragginsdesigns</a>
